...
int cutSetSize=0;                        
main(){
	Edge[0][1]=5;	Edge[0][2]=9;	Edge[0][3]=7;	Edge[1][4]=6;	Edge[2][4]=2;	Edge[2][5]=3;	Edge[3][5]=6;	Edge[3][6]=1;	Edge[4][7]=8;	Edge[5][7]=6;	Edge[6][7]=7;	Edge[1][2]=3;	Edge[3][2]=4;	Edge[4][5]=4;	Edge[5][6]=4;
	int i,j;
	//int cut[V]={0};	
