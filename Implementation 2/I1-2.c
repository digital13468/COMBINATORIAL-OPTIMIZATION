...
int cutSetSize=0;                        
main(){
	Edge[1][0]=5.38724;	Edge[1][3]=9.43;	Edge[1][7]=7.378;	Edge[0][4]=6.71;	Edge[3][4]=2.83;	Edge[3][6]=3.3453;	Edge[7][6]=6.453;	Edge[7][2]=1.91;	Edge[4][5]=8.845;	Edge[6][5]=6.63;	Edge[2][5]=7.7343;	Edge[0][3]=3.13;	Edge[7][3]=4.45;	Edge[4][6]=4.7839;	Edge[6][2]=4.34;
	int i,j;
	//int cut[V]={0};	
