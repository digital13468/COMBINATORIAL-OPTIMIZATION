...
int cutSetSize=0;                        
main(){
	Edge[7][8]=6.0;	Edge[7][9]=10.0;	Edge[7][6]=13.0;	Edge[8][10]=8.0;	Edge[8][5]=1.0;	Edge[9][10]=4.0;	Edge[6][5]=5.0;	Edge[6][2]=3.0;	Edge[10][3]=2.0;	Edge[5][3]=6.0;	Edge[2][1]=1.0;	Edge[2][4]=9.0;	Edge[3][0]=10.0;	Edge[1][0]=8.0;	Edge[4][0]=6.0;
	int i,j;
	//int cut[V]={0};	
