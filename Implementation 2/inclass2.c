...
int cutSetSize=0;                        
main(){
	Edge[0][1]=6.0;	Edge[0][2]=10.0;	Edge[0][3]=13.0;	Edge[1][4]=8.0;	Edge[1][5]=1.0;	Edge[2][4]=4.0;	Edge[3][5]=5.0;	Edge[3][6]=3.0;	Edge[4][7]=2.0;	Edge[5][7]=6.0;	Edge[6][8]=1.0;	Edge[6][9]=9.0;	Edge[7][10]=10.0;	Edge[8][10]=8.0;	Edge[9][10]=6.0;
	int i,j;
	//int cut[V]={0};	
