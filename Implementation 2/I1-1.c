...
int cutSetSize=0;                        
main(){
	Edge[1][0]=5;	Edge[1][3]=9;	Edge[1][7]=7;	Edge[0][4]=6;	Edge[3][4]=2;	Edge[3][6]=3;	Edge[7][6]=6;	Edge[7][2]=1;	Edge[4][5]=8;	Edge[6][5]=6;	Edge[2][5]=7;	Edge[0][3]=3;	Edge[7][3]=4;	Edge[4][6]=4;	Edge[6][2]=4;
	int i,j;
	//int cut[V]={0};	
