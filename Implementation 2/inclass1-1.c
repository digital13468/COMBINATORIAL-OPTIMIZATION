...
int cutSetSize=0;                        
main(){
	Edge[4][5]=6.0;	Edge[4][6]=3.0;	Edge[4][7]=1.0;	Edge[5][0]=3.0;	Edge[5][1]=2.0;	Edge[6][0]=3.0;	Edge[6][1]=4.0;	Edge[6][2]=1.0;	Edge[7][1]=3.0;	Edge[7][2]=7.0;	Edge[0][3]=9.0;	Edge[1][3]=6.0;	Edge[2][3]=10.0;
	int i,j;
	//int cut[V]={0};	
